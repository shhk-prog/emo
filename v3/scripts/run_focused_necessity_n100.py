...
def prebuild_pair_tensors(eval_pairs, tokenizer, candidates, device="cuda"):
    ...
    for pid, peak_row, neut_row in eval_pairs:
        ...
        # Build 81 sequences for peak
        full_seqs_peak = [peak_ids + c for c in cand_ids_list]
